...
const topics: Topic[] = [
  ...
  { id: 'plant-cost', title: 'Plant P&L', description: 'Profit & Loss Calculator', category: 'production', icon: DollarSign, modal: PlantCostModal, isPro: true, color: 'from-lime-100 to-green-200'},
